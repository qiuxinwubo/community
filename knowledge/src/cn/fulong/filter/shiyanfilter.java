...
public class shiyanfilter implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest paramHttpServletRequest,
		...
		if (user == null) {
			paramHttpServletResponse.sendRedirect(paramHttpServletRequest.getContextPath()+"/shiyan/loginbefore.action");
			return false;
		}
		return true;
	}
