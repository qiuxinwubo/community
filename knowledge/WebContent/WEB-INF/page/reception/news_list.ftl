...
<body>
	<div id="top"></div>
	<div>
		<iframe id="test" name="mainFrame" onload="reinitIframe();" frameborder=0  style="width: 100%;height:1400px;" src="http://www.smebj.cn/ncms/show.action?code=jumpchanneltemplate&siteid=100530&channelid=0000001509"></iframe>
	</div>
	<div id="under"></div>
</body>
</html>