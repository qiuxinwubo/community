...
<div class="container">
  ...
  <div class="right">
        <div class="position">当前位置&nbsp;&nbsp;>&nbsp;&nbsp;平台管理员账户&nbsp;&nbsp;>&nbsp;&nbsp;<span>商品审核</span></div>
        ...
        <form>      
                    ...
                    <div>
                    	<center>
                            <a href="${base}/backstagemerchant/baproductaudit.action?id=${args.id?if_exists}&state=3" class="save">审核通过</a>
                            <a href="${base}/backstagemerchant/baproductaudit.action?id=${args.id?if_exists}&state=4" class="save">审核不通过</a>
