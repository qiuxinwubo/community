...
<div class="error1">
 <span class="fl"><img src="<%= path%>/common/images/400.gif" width="382" height="253" /></span>
 <span class="fr"><img src="<%= path%>/common/images/notice2.png" class="margin06" width="230" height="97" />
