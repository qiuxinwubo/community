...
<div class="error3">
 <span class="fl"><img src="<%= path%>/common/images/500.gif" width="382" height="253" /></span>
 <span class="fr"><img src="<%= path%>/common/images/notice3.png" class="margin06" width="527" height="97" />
